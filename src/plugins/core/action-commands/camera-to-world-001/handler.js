...
module.exports = function handler(payload) {
  ...
  if (!objectInstance) {
    require('../../api/log')
      .createActionCommandLogger(payload, 'AC_CAMERA_TO_WORLD_001_NAME')
  ...
  position = require('../../api/coord/camera-position-to-world')(inputXVariable.getValue(), inputYVariable.getValue());
