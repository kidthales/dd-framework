...
module.exports = function handler(payload) {
  ...
  session = require('../../api/print-messages/begin-relative-position-session')(objectInstance, {
    ...
    background: {
      ...
      imageId: payload.param[paramIds.backgroundImage],
      imageFrame: cc.rect(
        payload.param[paramIds.backgroundImageFrameX],
        payload.param[paramIds.backgroundImageFrameY],
        payload.param[paramIds.backgroundImageFrameWidth],
        payload.param[paramIds.backgroundImageFrameHeight]
      ),
      capInsetRect: cc.rect(
        payload.param[paramIds.backgroundCapInsetX],
        payload.param[paramIds.backgroundCapInsetY],
        payload.param[paramIds.backgroundCapInsetWidth],
        payload.param[paramIds.backgroundCapInsetHeight]
      )
    }
  });
